...
const Logo = () => {
  return (
    <>
      <div className="col-left flex col-span-1 px-0 py-0 ">
        <div className=" pt-1  w-12 h-12 justify-center  ">
          <svg
            width="115"
            height="40"
            viewBox="0 0 115 40"
        ...
        <div>
          <div className="text-xl font-bold">Tinhte</div>
          <div className=" px-0 py-0 text-xs">MẠNG XÃ HỘI</div>
        </div>
      </div>
    </>
  );
